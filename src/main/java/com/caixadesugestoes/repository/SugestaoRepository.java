...
public interface SugestaoRepository extends JpaRepository<Sugestao, Long> {
    @Query(value = "SELECT * FROM sugestao", nativeQuery = true)
    List<Sugestao> listarTodas();

    @Modifying
    @Query(value = "INSERT INTO sugestao (descricao, categoria, usuario_id) VALUES (:descricao, :categoria, :usuarioId) RETURNING id", nativeQuery = true)
    Long enviarSugestao(@Param("descricao") String descricao, @Param("categoria") String categoria, @Param("usuarioId") Long usuarioId);
